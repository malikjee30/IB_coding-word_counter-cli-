...
console.log(chalk.bold.underline.yellowBright("(((((===> WEL COME TO OUR NEW CLI PROJECT OF WORDS COUNTER APP <===)))))\n"));
let myloop = true;
while (myloop) {
    const userInput = await inquirer.prompt([
        {
            type: "input",
            name: "para",
            message: chalk.magenta("Enter your paragraph to count letters and words in it!"),
        },
        {
            type: "list",
            name: "ask",
